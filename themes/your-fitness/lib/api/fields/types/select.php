...
yourfitness_add_smart_action( 'yourfitness_field_select', 'yourfitness_field_select' );
 ...
 * }
 */
function yourfitness_field_select( $field ) {

	if ( empty( $field['options'] ) )
		return;

	?>
	<select name="<?php echo esc_attr( $field['name'] ); ?>" <?php echo yourfitness_esc_attributes( $field['attributes'] );?>>
