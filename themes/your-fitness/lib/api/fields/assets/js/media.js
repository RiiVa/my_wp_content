(function($){
	...
	var torbaraFieldImage = function( element, options ) {
	...
	torbaraFieldImage.prototype = {

		constructor: torbaraFieldImage,
		...
		sortable: function() {
			...
			this.container.find( '.bs-images-wrap' ).sortable( {
				handle: '.bs-toolbar .dashicons-menu',
		...
		listen: function() {
			...
			this.container.on( 'click', '.dashicons-post-trash', function( e ) {
			...
			this.container.on( 'click', '.dashicons-edit', function( e ) {
	 ...
	 $.fn[ 'torbaraFieldImage' ] = function ( options ) {

		return this.each( function() {

			if ( !$.data( this, 'plugin_torbaraFieldImages' ) )
				$.data( this, 'plugin_torbaraFieldImage', new torbaraFieldImage( this, options ) );
	...
	$( document ).ready( function( $ ) {
		 ...
		 $( '.bs-field.bs-image' ).torbaraFieldImage();
