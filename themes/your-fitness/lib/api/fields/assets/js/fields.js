!(function($) {
    ...
    var torbaraFields = function( element, options ) {
    ...
    torbaraFields.prototype = {

        constructor: torbaraFields,
    ...
    $.fn[ 'torbaraFields' ] = function ( options ) {

        return this.each( function() {

            if ( !$.data( this, 'plugin_torbaraFields' ) )
                $.data( this, 'plugin_torbaraFields', new torbaraFields( this, options ) );
    ...
    $( document ).ready( function( $ ) {
        ...
        $( '#edittag, #post-body, .bs-options' ).torbaraFields();
        ...
        if ( wp.customize !== undefined ) {
            ...
            wp.customize.bind( 'ready', function() {
                ...
                $( '#customize-controls' ).torbaraFields();
