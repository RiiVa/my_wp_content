<?php
/**
 * The torbara WP Customize component extends the torbara Fields and make it easy add options to the
 * WP Theme Customizer.
 *
 ...
 */
function yourfitness_register_wp_customize_options( array $fields, $section, $args = array() ) {
	 ...
	 */
	$fields = apply_filters( "yourfitness_wp_customize_fields_{$section}", yourfitness_tt_pre_standardize_fields( $fields ) );
	...
	if ( !yourfitness_register_fields( $fields, 'wp_customize', $section ) )
		return false;

	// Load the class only if this function is called to prevent unnecessary memory usage.
        load_template( yourfitness_API_PATH . 'wp-customize/class.php', true );

	new yourfitness_tt_WP_Customize( $section, $args );
