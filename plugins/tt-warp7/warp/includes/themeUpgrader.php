...
// Destroy the session
function ttWarp_EndSession() {
    @session_destroy();
}
add_action('init', 'ttWarp_StartSession', 1);
add_action('wp_logout', 'ttWarp_EndSession');
add_action('wp_login', 'ttWarp_EndSession');
