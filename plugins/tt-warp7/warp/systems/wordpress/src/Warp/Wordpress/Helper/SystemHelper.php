...
class SystemHelper extends AbstractHelper
{
    ...
    public function __construct(Warp $warp)
    {
        ...
        $this->cache_path = rtrim(str_replace(DIRECTORY_SEPARATOR, '/', ABSPATH), '/').'/cache';
    ...
    public function _wp()
    {
        ...
        $this['template']->set('branding', $this['config']['branding']);
    ...
    public function _adminInit()
    {
        ...
        if (isset($_GET['page']) && $_GET['page'] == 'warp') {
            ...
            wp_enqueue_script('warp-js-chosen', preg_replace($siteurl, '', $this['path']->url('config:js/chosen.jquery.min.js'), 1));
            
            wp_enqueue_script('warp-js-periodpicker', preg_replace($siteurl, '', $this['path']->url('config:js/jquery.periodpicker.full.min.js'), 1));
            wp_enqueue_script('warp-js-timepicker', preg_replace($siteurl, '', $this['path']->url('config:js/jquery.timepicker.min.js'), 1));
            ...
            wp_enqueue_style('warp-css-chosen', preg_replace($siteurl, '', $this['path']->url('config:css/chosen.css'), 1));
            
            wp_enqueue_style('warp-css-mmnt', preg_replace($siteurl, '', $this['path']->url('config:css/periodtimepicker.css'), 1));
        }
