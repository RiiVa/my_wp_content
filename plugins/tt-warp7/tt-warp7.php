...
@include_once 'warp/includes/themeUpgrader.php';

// Functionality
@include_once 'warp/includes/functionality.php';

// Add Widgets Shortcode support 
@include_once 'warp/includes/widgetShortcode.php';

// Custom Category Templates
@include_once 'warp/includes/CustomCategoryTemplates.php';
