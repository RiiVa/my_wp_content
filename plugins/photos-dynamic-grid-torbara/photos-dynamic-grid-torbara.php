<?php
/*
 * Plugin Name: Photos Dynamic grid torbara
...
class PhotosDynamicGridTorbara extends WP_Widget{
    public function __construct() {
        parent::__construct("photos-dynamic-grid-torbara", "Photos dynamic grid torbara",
    ...
    $QueryArgs = array(
        ...
        <!-- Dynamic Grid -->
        <div  class="uk-grid uk-grid-collapse" data-uk-grid="{controls: '#tt-dgt', animation: true, duration: 300}">
    ...
    <div class="uk-width-1-3" data-uk-filter="<?php  echo mb_strtolower($cats[0]->name); ?>" style="position: relative;"> 
      <a href="<?php echo wp_get_attachment_url( get_post_thumbnail_id($post->ID)); ?>" data-uk-lightbox="{group:'group1'}">
                <img src="<?php echo wp_get_attachment_url( get_post_thumbnail_id($post->ID)); ?>"  alt="<?php echo $item->category_title ?>" class="blur" />
      </a>
      
    </div>
      <?php }else{ ?>          
                     
    <div class="uk-width-1-2" data-uk-filter="<?php  echo mb_strtolower($cats[0]->name); ?>" style="position: relative;">
     <a href="<?php echo wp_get_attachment_url( get_post_thumbnail_id($post->ID)); ?>" data-uk-lightbox="{group:'group1'}">
                <img src="<?php echo wp_get_attachment_url( get_post_thumbnail_id($post->ID)); ?>"  alt="<?php echo $item->category_title ?>" class="blur"/>
     </a>
...
add_action("widgets_init", function () {
    register_widget("PhotosDynamicGridTorbara");
});
